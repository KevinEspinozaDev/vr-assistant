...
interface ImportMetaEnv {
  ...
  readonly NG_APP_KEY_CHATGPT: string;
  readonly NG_APP_API_URL_CHAT_GPT: string;

  readonly NG_APP_KEY_ELEVENLABS: string;
  readonly NG_APP_API_URL_ELEVENLABS: string;

  readonly NG_APP_API_GOOGLE_URL: string;
}
